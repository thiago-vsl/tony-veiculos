...
<html>
  <head>
    ...
    <title>Tony Ve&iacute;culos</title>
  </head>
  <body>
    ...
    <div class="container">
		<div class="card-background text-center">
			...
			<div class="card-container text-center">
				...
				<div>
					<input type="text" class="input-dados" placeholder="Nome" name="tnv_nome" id="tnv_nome">
					<input type="text" class="input-dados" placeholder="Telefone" name="tnv_telefone1" id="tnv_telefone1">
					<div id='card-telefones'>
					</div>
					<button type="button" class="btn btn-primary botao-padrao2" onclick="incluirTelefone()">Incluir mais Telefones</button>
				</div>
				<div>
					<button type="button" class="btn btn-primary botao-padrao" onclick="enviar_dados()">ENVIAR</button>
				</div>
			</div>
			<div class="card-container text-center">
				<div class="card-texto40_2">
